...
# Configuration
# =====================================================
VIDEO_PATH = r"C:\Users\GANAPATHI\Downloads\HSBC Play of the Day  Impenetrable defence! - BWF TV (1080p, h264, youtube).mp4"
FRAME_NUMBER = 0

WINDOW_NAME = "Badminton Court Calibration - 13 Handles"
SAVE_JSON = "court_calibration_13handles.json"
...
def main():
    ...
    annotator = CourtAnnotator(frame)
    annotator.run()
